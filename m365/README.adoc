...
`terraform_azurerm_environment` (string) [default=public]::: The environment can be set to 'public' for the global Azure cloud, or 'usgovernment' for the Azure US Government cloud.
